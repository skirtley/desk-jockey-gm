...
$aDefaultTemplateValues = array(
	'fetch_tweets_template_djgm_avatar_size' => 48,
	'fetch_tweets_template_djgm_avatar_position' => 'left',
	'fetch_tweets_template_djgm_width' => array( 'size' => 100, 'unit' => '%' ),
	'fetch_tweets_template_djgm_height' => array( 'size' => 400, 'unit' => 'px' ),
	'fetch_tweets_template_djgm_background_color' => 'transparent',
	'fetch_tweets_template_djgm_intent_buttons' => 2,
	'fetch_tweets_template_djgm_intent_script' => 1,
	'fetch_tweets_template_djgm_visibilities' => array(
		'avatar' => true,
		'user_name' => true,
		// 'follow_button' => true,
...
if ( ! isset( $aOptions['fetch_tweets_template_djgm'] ) ) {	// for the first time of calling the template.
	$aOptions['fetch_tweets_template_djgm'] = $aDefaultTemplateValues;
...
$aTemplateOptions = FetchTweets_Utilities::uniteArrays( $aOptions['fetch_tweets_template_djgm'], $aDefaultTemplateValues );	// unites arrays recursively.

// Finalize the template option values.
$aArgs['avatar_size']				= isset( $aArgs['avatar_size'] ) ? $aArgs['avatar_size'] : $aTemplateOptions['fetch_tweets_template_djgm_avatar_size'];
$aArgs['avatar_position']			= isset( $aArgs['avatar_position'] ) ? $aArgs['avatar_position'] : $aTemplateOptions['fetch_tweets_template_djgm_avatar_position'];
$aArgs['width']						= isset( $aArgs['width'] ) ? $aArgs['width'] : $aTemplateOptions['fetch_tweets_template_djgm_width']['size'];
$aArgs['width_unit']				= isset( $aArgs['width_unit'] ) ? $aArgs['width_unit'] : $aTemplateOptions['fetch_tweets_template_djgm_width']['unit'];
$aArgs['height']					= isset( $aArgs['height'] ) ? $aArgs['height']: $aTemplateOptions['fetch_tweets_template_djgm_height']['size'];
$aArgs['height_unit']				= isset( $aArgs['height_unit'] ) ? $aArgs['height_unit'] : $aTemplateOptions['fetch_tweets_template_djgm_height']['unit'];
$aArgs['background_color']			= isset( $aArgs['background_color'] ) ? $aArgs['background_color'] : $aTemplateOptions['fetch_tweets_template_djgm_background_color'];
$aArgs['visibilities']				= isset( $aArgs['visibilities'] ) ? $aArgs['visibilities'] : $aTemplateOptions['fetch_tweets_template_djgm_visibilities'];
$aArgs['margin_top']				= isset( $aArgs['margin_top'] ) ? $aArgs['margin_top'] : $aTemplateOptions['fetch_tweets_template_djgm_margins'][0]['size'];
$aArgs['margin_top_unit']			= isset( $aArgs['margin_top_unit'] ) ? $aArgs['margin_top_unit'] : $aTemplateOptions['fetch_tweets_template_djgm_margins'][0]['unit'];
$aArgs['margin_right']				= isset( $aArgs['margin_right'] ) ? $aArgs['margin_right'] : $aTemplateOptions['fetch_tweets_template_djgm_margins'][1]['size'];
$aArgs['margin_right_unit']			= isset( $aArgs['margin_right_unit'] ) ? $aArgs['margin_right_unit'] : $aTemplateOptions['fetch_tweets_template_djgm_margins'][1]['unit'];
$aArgs['margin_bottom']				= isset( $aArgs['margin_bottom'] ) ? $aArgs['margin_bottom'] : $aTemplateOptions['fetch_tweets_template_djgm_margins'][2]['size'];
$aArgs['margin_bottom_unit']		= isset( $aArgs['margin_bottom_unit'] ) ? $aArgs['margin_bottom_unit'] : $aTemplateOptions['fetch_tweets_template_djgm_margins'][2]['unit'];
$aArgs['margin_left']				= isset( $aArgs['margin_left'] ) ? $aArgs['margin_left'] : $aTemplateOptions['fetch_tweets_template_djgm_margins'][3]['size'];
$aArgs['margin_left_unit']			= isset( $aArgs['margin_left_unit'] ) ? $aArgs['margin_left_unit'] : $aTemplateOptions['fetch_tweets_template_djgm_margins'][3]['unit'];
$aArgs['padding_top']				= isset( $aArgs['padding_top'] ) ? $aArgs['padding_top'] : $aTemplateOptions['fetch_tweets_template_djgm_paddings'][0]['size'];
$aArgs['padding_top_unit']			= isset( $aArgs['padding_top_unit'] ) ? $aArgs['padding_top_unit'] : $aTemplateOptions['fetch_tweets_template_djgm_paddings'][0]['unit'];
$aArgs['padding_right']				= isset( $aArgs['padding_right'] ) ? $aArgs['padding_right'] : $aTemplateOptions['fetch_tweets_template_djgm_paddings'][1]['size'];
$aArgs['padding_right_unit']		= isset( $aArgs['padding_right_unit'] ) ? $aArgs['padding_right_unit'] : $aTemplateOptions['fetch_tweets_template_djgm_paddings'][1]['unit'];
$aArgs['padding_bottom']			= isset( $aArgs['padding_bottom'] ) ? $aArgs['padding_bottom'] : $aTemplateOptions['fetch_tweets_template_djgm_paddings'][2]['size'];
$aArgs['padding_bottom_unit']		= isset( $aArgs['padding_bottom_unit'] ) ? $aArgs['padding_bottom_unit'] : $aTemplateOptions['fetch_tweets_template_djgm_paddings'][2]['unit'];
$aArgs['padding_left']				= isset( $aArgs['padding_left'] ) ? $aArgs['padding_left'] : $aTemplateOptions['fetch_tweets_template_djgm_paddings'][3]['size'];
$aArgs['padding_left_unit']			= isset( $aArgs['padding_left_unit'] ) ? $aArgs['padding_left_unit'] : $aTemplateOptions['fetch_tweets_template_djgm_paddings'][3]['unit'];
$aArgs['intent_buttons']			= isset( $aArgs['intent_buttons'] ) ? $aArgs['intent_buttons'] : ( ! $aArgs['visibilities']['intent_buttons'] ? 0 : $aTemplateOptions['fetch_tweets_template_djgm_intent_buttons'] );	// 0: do not show, 1: icons and text, 2: only icons, 3: only text.
$aArgs['intent_button_script']		= isset( $aArgs['intent_button_script'] ) ? $aArgs['intent_button_script'] : $aTemplateOptions['fetch_tweets_template_djgm_intent_script'];
