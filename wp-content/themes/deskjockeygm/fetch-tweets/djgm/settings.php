 ...
 * @subpackage	DJGM Tweets
 * @see			http://wordpress.org/plugins/admin-page-framework/
 */
class FetchTweets_Template_Settings_DJGM extends FetchTweets_Template_Settings {

	/*
	 * Modify these properties.
	 * */
	protected $sParentPageSlug = 'fetch_tweets_templates';	// in the url, the ... part of ?page=... 
	protected $sParentTabSlug = 'djgm';	// in the url, the ... part of &tab=...
	protected $sTemplateName = 'DJGM';	// the template name
	protected $sSectionID = 'fetch_tweets_template_djgm';
	...
	public function addSettingFields( $aFields ) {
		...
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_avatar_size'] = array(
			'field_id' => 'fetch_tweets_template_djgm_avatar_size',
			'section_id' => $this->sSectionID,
		...
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_avatar_position'] = array(
			'field_id' => 'fetch_tweets_template_djgm_avatar_position',
			'section_id' => $this->sSectionID,
		...
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_width'] = array(
			'field_id' => 'fetch_tweets_template_djgm_width',
			'section_id' => $this->sSectionID,
		...
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_height'] = array(
			'field_id' => 'fetch_tweets_template_djgm_height',
			'section_id' => $this->sSectionID,
		...
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_margins'] = array(
			'field_id' => 'fetch_tweets_template_djgm_margins',
			'section_id' => $this->sSectionID,
		...
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_paddings'] = array(
			'field_id' => 'fetch_tweets_template_djgm_paddings',
			'section_id' => $this->sSectionID,
		...
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_background_color'] = array(
			'field_id' => 'fetch_tweets_template_djgm_background_color',
			'section_id' => $this->sSectionID,
			'title' => __( 'Background Color', 'fetch-tweets' ),
			'type' => 'color',
			'default' => 'transparent',
		);		
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_intent_buttons'] = array(
			'field_id' => 'fetch_tweets_template_djgm_intent_buttons',
			'section_id' => $this->sSectionID,
		...
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_intent_script'] = array(
			'field_id' => 'fetch_tweets_template_djgm_intent_script',
			'section_id' => $this->sSectionID,
		...
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_visibilities'] = array(
			'field_id' => 'fetch_tweets_template_djgm_visibilities',
			'section_id' => $this->sSectionID,
		...
		$aFields[ $this->sSectionID ]['fetch_tweets_template_djgm_submit'] = array(
			'field_id' => 'fetch_tweets_template_djgm_submit',
			'section_id' => $this->sSectionID,
			'type' => 'submit',
...
new FetchTweets_Template_Settings_DJGM( dirname( __FILE__ ) );